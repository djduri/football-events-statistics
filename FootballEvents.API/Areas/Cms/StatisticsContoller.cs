...
using FootballEvents.Application.Features.Teams.MatchRecords.Commands.AddMatchRecord;
using MediatR;
...
public class StatisticsContoller: CmsController
{
    ...
    [AllowAnonymous]
    [Microsoft.AspNetCore.Mvc.HttpPost("EventCreate")]
    [SwaggerOperation(OperationId = "EventCreate")]
    public async Task<ActionResult<string>> PostEventCreate(AddMatchRecordCommand command) =>
